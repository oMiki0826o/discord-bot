...
_DEFAULTS: dict[str, Any] = {
    ...
    "ai.default_model":        "gemini",
    "ai.model_pools.gemini":   [
        "gemini-3.1-flash-lite", "gemini-3.5-flash-lite",
    ],
    "ai.model_pools.flash":    [
        "gemini-2.5-flash", "gemini-3-flash-preview", "gemini-3.5-flash",
        "gemini-3.6-flash", "gemini-3.7-flash", "gemini-3.8-flash",
    ],
    "ai.model_pools.gemma":    ["gemma-4-31b-it"],
    "ai.model_quota_cooldown_seconds": 300,
    "ai.model_timeout_seconds": 15.0,
    "ai.max_model_attempts":    2,
    "ai.model_server_retries":  2,
    "ai.max_output_tokens":     1200,
    "ai.stream_update_interval_seconds": 1.0,
    "ai.cooldown_seconds":     3.0,
    "ai.allow_other_applications": True,
    "ai.show_prompt":             False,
    "ai.prompt_log_channel_id":   1550078091949506622,
    "ai.max_reply_length":     1500,
    "ai.max_attachments":      5,
    "ai.attachment_concurrency": 3,
    "ai.prompt_max_tokens":    32768,
    "ai.max_input_chars":      32000,
    "ai.prompt_max_chars":     8000,
    "ai.channel_context_enabled": True,
    "ai.channel_context_message_limit": 50,
    "ai.channel_context_token_limit": 6000,
    "ai.channel_context_message_max_chars": 1000,
    "ai.channel_context_include_bots": True,
    "ai.persona_name":         "流螢",
    "ai.default_attachment_prompt": "請分析我提供的附件，先說明內容與重點。若附件無法完整解析，請說明限制，不要猜測。",
    "ai.empty_prompt_message": "怎麼了嗎？",
    "ai.busy_message":         "上一件事情還沒弄完，等一下。",
    "ai.cooldown_message_template": "等個 {seconds:g} 秒再試試看。",
    "ai.long_reply_notice":    "東西有點太多了，轉成文字檔案給你了。",
    "ai.empty_reply_message":  "（我想不到怎麼說，你再問一次。）",
    "ai.error_message_template": "啊，出錯了。錯誤：{error}。",
    ...
    "ai.memory_candidate_limit": 200,
    "ai.message_candidate_limit": 100,
    "ai.recent_message_limit": 10,
    "ai.vector_candidate_limit": 5,
    "ai.memory_vectorize_delay_seconds": 1.0,
    "ai.memory_semantic_threshold": 0.68,
    "ai.memory_summary_new_message_trigger": 10,
    ...
    "music.idle_disconnect_message": "超過三分鐘沒事了，我先溜了 👋",
